...
availability_operation(OpCode,Room,Day,Interval,LDoctorsSurgery, LStaffAnesthesia, LStaffCleaning):-
    ...
    once(find_first_interval(LAnesthesia, LSurgery, LCleaning, LFAgRoom, TAnesthesia, TSurgery, TCleaning, Interval)).

find_first_interval(LAnesthesia, LSurgery, LCleaning, RoomsAvailable, TAnesthesia, TSurgery, TCleaning, Interval) :-
    ...
    EndSurgery is StartAnesthesia + TAnesthesia + TSurgery + TCleaning,

    Interval = (StartAnesthesia, EndSurgery).
